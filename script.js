document.addEventListener('DOMContentLoaded', () => {
    ...
    const questions = [
        ...
        {
            question: "Скільки є світів в Майнкрафті?",
            answers: ["2", "3", "5", "4"],
            correct: 1
        },
        {
            question: "Кого боїться Скелет?",
            answers: ["кіт", "собак", "голема", "селян"],
            correct: 0
        },
        {
            question: "де знаходяться селян?",
            answers: ["Незер", "Звичайний світ", "Печері", "Енд"],
            correct: 1
        },
        {
            question: " а де є багато золота ",
            answers: ["Незер", "шахта", "Енд", "Звичайний світ"],
            correct: 1
        },
        {
            question: "а де є Ендермен?",
            answers: ["Печері", "Енд", "шахта", "Незер"],
            correct: 1
        },
        {
            question: "яка зброя має утоплиника?",
            answers: ["тризубець", "мушля", "гнила плоть", "блок"],
            correct: 0
        },
    ];
    ...
    function checkAnswer(button, i) {
        ...
        scoreDisplay.innerText = `💎 Діаманти: ${score}`;
    ...
    function startGame() {
        ...
        questionIndex = 0;
        score = 0;
        scoreDisplay.innerText = `💎 Діаманти: 0`;
        showQuestion(questions[questionIndex]);
    }
